...
r_HalfDR = create_summary("baseHalfDR";
   samples=samples, 
   storage_case=storage_case,  
   ref_poe_scen_sets=ref_poe_scen_sets,
   resilience_events=[],
...
p1 = histogram(e11.magnitude_mwh ./ 1e3,  label="", alpha=0.1,
   c=:grey, lw=0, title="Low VRE availability (reference weather year 2011)"; kwargs...)
p1 = stephist!(e11.magnitude_mwh ./ 1e3, label="Supply case", alpha=1.0, lw=3,
   c=:grey; kwargs...)

p1 = histogram!(e_EV11.magnitude_mwh ./ 1e3, label="", alpha=0.1, c=1, palette=:batlow10,
    lw=0; kwargs...)
p1 = stephist!(e_EV11.magnitude_mwh ./ 1e3, label="50% EV", c=1, palette=:batlow10, lw=3; kwargs...)


p1 = histogram!(e_VPP11.magnitude_mwh ./ 1e3,  label="", alpha=0.1,c=5, palette=:batlow10,
    lw=0; kwargs...)
p1 = stephist!(e_VPP11.magnitude_mwh ./ 1e3,  label="100% VPP", c=5, palette=:batlow10, lw=3; kwargs...)

p1 = histogram!(e_DR11.magnitude_mwh ./ 1e3, label="", alpha=0.1, c=:black,
    lw=0; kwargs...)
p1 = stephist!(e_DR11.magnitude_mwh ./ 1e3, label="100% DSP",  c=:black, lw=3; kwargs...)

p2 = histogram(e19.magnitude_mwh ./ 1e3,  label="", alpha=0.1,
   c=:grey, lw=0, title="High VRE availability (reference weather year 2019)"; kwargs...)
p2 = stephist!(e19.magnitude_mwh ./ 1e3, label="Supply case", alpha=1.0, lw=3,
   c=:grey; kwargs...)
p2 = histogram!(e_EV19.magnitude_mwh ./ 1e3, label="", alpha=0.1, c=1, palette=:batlow10,
    lw=0; kwargs...)
p2 = stephist!(e_EV19.magnitude_mwh ./ 1e3, label="50% EV", c=1, palette=:batlow10, lw=3; kwargs...)
p2 = histogram!(e_VPP19.magnitude_mwh ./ 1e3,  label="", alpha=0.1,c=5, palette=:batlow10,
    lw=0; kwargs...)
p2 = stephist!(e_VPP19.magnitude_mwh ./ 1e3,  label="100% VPP", c=5, palette=:batlow10, lw=3; kwargs...)
p2 = histogram!(e_DR19.magnitude_mwh ./ 1e3, label="", alpha=0.1, c=:black,
    lw=0; kwargs...)
p2 = stephist!(e_DR19.magnitude_mwh ./ 1e3, label="100% DSP",  c=:black, lw=3,
   xlabel="Recorded USE per load shedding event [GWh]"; kwargs...)

plot(p1, p2, layout=(2,1), size=(800,600), bottommargin=5Plots.mm, leftmargin=5Plots.mm)
savefig(joinpath(@__DIR__, "figures", "4-DERcoordination_event_size_distribution.png"))
